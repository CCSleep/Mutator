...
<div class="row">
  ...
  <div class="col-md-4"><center><form method="post"><span><h1>Add Announcement</h1><br><input type="text" name="cc" class="form-control" placeholder="Homework"></span><br><button type="submit" class="btn btn-block btn-success">Submit</button></form></center></div>
  <div class="col-md-4"></div>
</div>
<br>
<?php } ?>
